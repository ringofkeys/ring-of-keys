    ...
    return (
        <>
            ...
            <Popup isOpen={isPopupOpen} onClose={() => setPopupOpen(false)}>
                ...
                <div className="divider"></div>
                <p>
                    You will receive an email soon alerting you of your
                    acceptance to be a Key! Please add info@ringofkeys.org to
                    your contacts. Once accepted, you will be able to customize
                    your Key profile. <br />
...
async function submitApplication(data) {
    ...
    console.log(
        ...
        newUser.headshot.size > MAX_IMAGE_FILE_SIZE_IN_BYTES
            ? "above"
            : "within",
        " the limit of 4MB."
    )
