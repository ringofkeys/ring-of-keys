...
export function KeyBody() {
    const { artist, isEditable, isEditing, setEditing } =
        useContext(ProfileContext)

    const finalLocationVal =
        artist?.locations?.slice(artist?.locations?.lastIndexOf("| ") + 2) || ""
    const locationsOther =
        locations.findIndex((l) => l === finalLocationVal) < 0
            ? finalLocationVal
            : ""
    ...
    return (
        <section className={styles["artist_body"]}>
            ...
            {isEditing && (
                <>
                    ...
                    <KeyField
                        ...
                        heading={
                            <h3>
                                Pronouns
                                <InfoIcon
                                    infoText={PROFILE_INFO_COPY.pronouns}
                                />
                            </h3>
                        }
                    >
                    ...
                    <KeyField
                        ...
                        heading={<h3>Your Main Location</h3>}
                    >
                        ...
                        editFormFields={
                            ...
                            >
                                {locations.map((val) => (
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            type="checkbox"
                                            value={val}
                                            defaultChecked={artist?.locations.includes(
                                                val
                                            )}
                                        />
                                    </div>
                                ...
                                <div className={fieldStyles["input__group"]}>
                                    <label htmlFor="locationsOther">
                                        Other
                                    </label>
                                    <input
                                        type="text"
                                        name="locationsOther"
                                        defaultValue={locationsOther}
                                    />
                                </div>
                            </CheckboxGrid>
                        }
                        processDataCallback={(_, formSubmitEvent) => {
                            const locationArray = Array.from(
                                formSubmitEvent.currentTarget.elements[
                                    "locations[]"
                                ]
                            )
            ...
            <KeyField
                ...
                heading={
                    <h3>
                        Sexual Orientation
                        <InfoIcon
                            infoText={PROFILE_INFO_COPY.sexualOrientation}
                        />
                    </h3>
                }
            >
                ...
                editFormFields={
                    <div className={styles.toggleRow}>
                        ...
                        >
                            ...
                            <p>
                                Checking this box will display you on{" "}
                                <Link href="/consultancy">
                                    the Gender Consultancy page
                                </Link>{" "}
                                and may result in you receiving solicitation for
                                consulting work. Please only opt in if you are
                                comfortable with Ring of Keys sharing these
                                solicitations with you.
                            </p>
                        </label>
                    </div>
                }
                processDataCallback={(_, formSubmitEvent) => {
                    const isGenderConsultant =
                        formSubmitEvent.currentTarget.elements[
                            "isGenderConsultant"
                        ].checked
                    console.log({
                        isGenderConsultant,
                        formElements: formSubmitEvent.currentTarget.elements,
                    })
                    return {
                        isGenderConsultant,
                    }
            ...
            >
                <p>
                    {artist?.isGenderConsultant && (
                        <span>
                            Yes, I'm available to provide paid gender consulting
                            services for productions. Learn more about{" "}
                            <Link href="/consultancy">
                                Ring of Keys gender consultants here.
                            </Link>
                        </span>
                    )}
                </p>
            ...
            <KeyField
                ...
                heading={<h3>Dance Experience</h3>}
            >
            ...
            <KeyField
                        ...
                        {affiliations.map((val) => (
                            ...
                            >
                                ...
                                <input
                                    ...
                                    type="checkbox"
                                    value={val}
                                    defaultChecked={artist?.affiliations?.includes(
                                        val
                                    )}
                                />
                            </div>
                ...
                processDataCallback={(_, formSubmitEvent) => {
                    const affiliationArray = Array.from(
                        formSubmitEvent.currentTarget.elements["affiliations[]"]
                    )
                        .filter((field) => field.checked)
                        .map((field) => field.value)
            ...
            <KeyField fieldName="resume" heading={<h3>Resume</h3>}>
                <a
                    className={"btn " + styles["btn_resume"]}
                    href={artist?.resume}
                    rel="noopener noreferrer"
                    target="_blank"
                >
