...
const socialLinks = [
    ...
    (<svg version="1.1" xmlns="http://www.w3.org/2000/svg" className='icon_facebook'
    viewBox="0 0 266.893 266.895">
        <path id='fb_blue' fill="#fff" d="M248.082,262.307c7.854,0,14.223-6.369,14.223-14.225V18.812
        c0-7.857-6.368-14.224-14.223-14.224H18.812c-7.857,0-14.224,6.367-14.224,14.224v229.27c0,7.855,6.366,14.225,14.224,14.225
        H248.082z"/>
        <path id="fb_white" fill="#FFFFFF" d="M182.409,262.307v-99.803h33.499l5.016-38.895h-38.515V98.777c0-11.261,3.127-18.935,19.275-18.935
        l20.596-0.009V45.045c-3.562-0.474-15.788-1.533-30.012-1.533c-29.695,0-50.025,18.126-50.025,51.413v28.684h-33.585v38.895h33.585
        v99.803H182.409z"/>
    </svg>) },
    { label: 'Instagram', href: 'https://www.instagram.com/ringofkeysorg/', icon: (
    <svg className='icon_instagram' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    { label: 'Twitter', href: 'https://twitter.com/ringofkeysorg', icon: (
    ...
    { label: 'YouTube', href: 'https://www.youtube.com/channel/UCwrpjtLgs1K7A8bHxScfoGg', icon: (
    <svg version="1.1" className='icon_youtube' xmlns="http://www.w3.org/2000/svg" x="0px"
        y="0px" viewBox="0 0 1024 721">
    ...
    <svg className='icon_linkedin' viewBox="0 0 256 256">
        <g transform="scale(1.40) translate(-240.55198,-430.96227)">
            <g transform="matrix(1.018827,0,0,-1.018827,170.5996,498.03288)">
                ...
                <path d="M128.681-101.774h34.673v58.249
