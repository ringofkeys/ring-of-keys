...
function button(props) {
    const linkIsExternal = (url) => !url.startsWith('#') && !(url.includes('ringofkeys') || url.includes('localhost'))
...
function quote(props) {
    return <QuoteBlock quoteBgColor={ '#7b8c7d' } quoteTextColor={ '#e9bfb2' }
    quoteText={ props.quoteText } quoteAttribution={ props.quoteAttribution } />
}
