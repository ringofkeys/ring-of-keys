...
const HeroSocialMediaEditor = ({ field, editorState }) => (
  <Popup isOpen={field.isEditing} onClose={() => field.setEditing(false)}>
    ...
    <p>
      Go to your social media profile and copy &amp; paste the URL from the
      browser in the appropriate field
    </p>
    <form
    ...
    >
      {Object.keys(socialIcons).map(key => {
        const s = field.data.find(socialObj =>
          ...
          <div className="icon-field">
            ...
            <label>
              ...
              <input
                type="text"
                name={key}
                defaultValue={s ? s.socialMediaLink : ""}
      ...
      <div className="file-drop_btns">
        ...
        <button
          ...
          className={`btn ${editorState.isSubmitting ? "submitting" : ""}`}
        >
