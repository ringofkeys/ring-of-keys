...
const options = {
    ...
    providers: [
        Auth0Provider({
            ...
            authorization: { params: { scope: "openid profile email https://ringofkeys.org/user_metadata" } },
        })
    ],
    callbacks: { 
        ...
        //   console.log('Provider profile', oAuthProfile)
          ...
          if (auth0Token.profile) {
              auth0Token.token.datoId = auth0Token.profile["https://ringofkeys.org/user_metadata"]?.entity_id
          }
