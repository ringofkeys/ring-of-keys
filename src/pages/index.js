    ...
    <Layout>
      ...
      <div className={styles.index_hero}>
        ...
        <div className={styles["index_hero__right-col"]}>
          Ring of Keys is an artist service organization that fosters community
          and visibility for musical theatre artists - onstage and off - who
          self-identify as queer women, transgender, and gender non-conforming
          artists.
