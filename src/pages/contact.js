            ...
            <section className={styles.contactPage}>
                ...
                <div className={styles.socialRow}>
                    <SocialIcon
                        ...
                        src="/img/social-icons/icon_instagram_peach.svg"
                    />
                    <SocialIcon
                        label="Facebook"
                        href="https://www.facebook.com/RingofKeysOrg/"
                        src="/img/social-icons/icon_facebook_peach.svg"
                    />
                    <SocialIcon
                        label="Twitter"
                        href="https://twitter.com/ringofkeysorg"
                        src="/img/social-icons/icon_twitter_peach.svg"
                    />
                    <SocialIcon
                        label="Youtube"
                        href="https://www.youtube.com/channel/UCwrpjtLgs1K7A8bHxScfoGg"
                        src="/img/social-icons/icon_youtube_peach.svg"
                    />
                    <SocialIcon
                        label="LinkedIn"
                        href="https://www.linkedin.com/company/ring-of-keys/about/"
                        src="/img/social-icons/icon_linkedin_peach.svg"
                    />
                </div>
            </section>
        </Layout>
