...
export default function Dashboard({
            ...
            signIn("auth0", {
                callbackUrl:
                    process.env.NODE_ENV == "development"
                        ...
                        : "https://ringofkeys.org/dashboard",
            })
            return <Redirecting />
        },
    })
    ...
    async function downloadDemographicData() {
        const keyData = await fetch("/api/getKeyReportData").then((res) =>
            res.json()
        )
                        ...
                        <div className={styles.dashboardGrid}>
                            <section className={styles.infoSection}>
                                ...
                                <div className={styles.infoContent}>
                                    <h1>{user.name}</h1>
                                    <p className="text-xs">
                                        {user.pronouns} · Member since{" "}
                                        {user.memberSince}
                                    </p>
                                    <Link
                                        href={"/keys/" + user.slug}
                                        className={`my-4 ${styles.dashboardButton}`}
                                    >
                                        Edit Public Profile
                                    </Link>
                                    {user.keyTeamMember && (
                                        <button
                                            ...
                                            onClick={downloadDemographicData}
                                        >
                                            Get Report Data
                                        </button>
                                    )}
                                    ...
                                    <div>
                                        {user?.stripeId ? (
                                            <>
                                                <p className="text-xs">
                                                    ...
                                                    support our programming! You
                                                    can manage your donations
                                                    here.
                                                </p>
                                                <button
                                            ...
                                            <>
                                                <p className="text-xs">
                                                    Ring of Keys is a 501c3
                                                    non-profit that runs on
                                                    member donations. Please
                                                    consider donating if you are
                                                    able!
                                                </p>
                                                <button
                                                    onClick={() =>
                                        ...
                                        {user.stripeId &&
                                            ...
                                            accountNeedsReview(
                                                ...
                                                <p className="p-2 mt-4 text-xs text-red-700 rounded bg-red-50">
                                                    ❗️ Something appears to be
                                                    wrong with your billing,
                                                    please review by clicking
                                                    above.
                                                </p>
                                            )}
                                    </div>
                                ...
                                <div className={styles.workshopList}>
                                    {workshops?.length ? (
                                        ...
                                        <p className="text-center my-4 bg-blue-50 px-5 py-4 text-sm">
                                            No Workshops scheduled right now! If
                                            you'd like to run your own, we'll
                                            help you set one up. Just fill out{" "}
                                            <a
                                                href="https://docs.google.com/forms/d/e/1FAIpQLSd_cPfNXpX8SIHGlnB_Cc38RnfNMsQwrpZir3-xjvh21Wge5w/viewform?usp=sf_link"
                                                target="_blank"
                            ...
                            <section className={styles.newsSection}>
                                <div className="flex items-center gap-2">
                                    <Icon
                                        type="news"
                                        className="w-4"
                                        fill="var(--rok-pale-green-1_hex)"
                                    />
                                    <h2>News</h2>
                                </div>
                                <div className={styles.newsList}>
                                    {newsfeed?.length &&
                                        newsfeed.map((block, i) => (
                                ...
                                <section className={styles.communitySpotlight}>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p
                                                className={
                                                    styles.disciplineAndLocation
                                                }
                                            >
                                                {spotlight.pronouns} ·{" "}
                                                {spotlight.discipline} in{" "}
                                                {spotlight.mainLocation}
                                            </p>
                                        </div>
                                        <p
                                        ...
                                        >
                                            {
                                                spotlight.communitySpotlightMessage
                                            }
                                        </p>
                                    </a>
                                </section>
                            ...
                            <section className={styles.messagesSection}>
                                <div className={styles.contentBar}>
                                    <div>
                                        ...
                                        <p className="text-xs">
                                            Outreach from industry professionals
                                            through your public profile.
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-xs">
                                            Our team screens your messages for
                                            harassment. We can see initial
                                            outreach, but not your response via
                                            email.
                                        </p>
                                        ...
                                        <label className="flex items-center gap-2 my-2 font-normal">
                                            <input
                                                type="checkbox"
                                                name="hideMessageButton"
                                                checked={
                                                    user?.hideMessageButton
                                                }
                                                onChange={() =>
                                                    updateKey({
                                                        hideMessageButton:
                                ...
                                <div className="overflow-y-auto">
                                    {messages?.length ? (
                                        ...
                                        <p className="text-center my-4 bg-blue-50 px-5 py-4 text-sm">
                                            No messages just yet! Messages will
                                            be sent through the form on{" "}
                                            <Link
                                                href={"/keys/" + user.slug}
                                                className="text-blue-800 hover:text-blue-700"
                                            >
    ...
    return [
        {
            ...
            summary:
                "In this 2-hour workshop, you’ll learn tricks and tips for building a creative practice that works for YOU.",
            location: `Joe's Pub`,
        ...
        },
        {
            ...
            summary:
                "In this experiential brain training workshop, you will learn a series of mental practices to rewire your relationship with auditions.",
            location: "Virtual",
