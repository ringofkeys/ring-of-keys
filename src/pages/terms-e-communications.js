...
const TermsECommunications = ({ data }) => {
    ...
    return (<Layout title='Terms & Conditions for E-Communications' description='The e-communication terms & conditions for the Ring of Keys organization.'>
...
export const query = graphql`
    query ETermsService {
        pageContent: datoCmsLandingPage(title: { eq: "Terms and Conditions E-Communications" }) {
            bodyNode {
                childMarkdownRemark {
                    htmlAst
                }
